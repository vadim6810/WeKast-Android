...
public class WifiControllerOld {
    ...
    public boolean isWifiOn(Context context) {
        ...
        Log.d(TAG, "WifiControllerOld.isWifiOn(): " + isWifiOn);
        return isWifiOn;
    }
    ...
    public void turnOnOffWifi(Context context, boolean b) {
        ...
        Log.d(TAG, "WifiControllerOld.turnOnOffWifi(): " + b);
    }
...
//        Log.d(TAG, "WifiControllerOld.configureWifiConfig():\n" + wifiConfig);
    }
